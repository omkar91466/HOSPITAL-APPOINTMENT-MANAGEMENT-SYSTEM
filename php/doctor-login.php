...
if (!$email || $password === '') {
    redirect_to('../login.html#doctor', 'Enter your email and password to sign in.');
}
...
if (!$doctor || !password_verify($password, $doctor['password'])) {
    redirect_to('../login.html#doctor', 'The email or password is incorrect.');
}
